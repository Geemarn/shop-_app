...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> fetchProducts() async {
    const url = 'https://flutter-firebase-20fa6.firebaseio.com/product.json';
    try {
      ...
      encodedResponse.forEach((productKey, productValue) {
        loadedProduct.add(Product(
          id: productKey,
          title: productValue['title'],
          price: productValue['price'],
          description: productValue['description'],
          isFavourite: productValue['isFavourite'],
  ...
  Future<void> addProduct(Product product) async {
    ...
    try {
      ...
      _items.add(newProduct); //at the end
      // _items.insert(0, newProduct); //at the neginning
      notifyListeners();
    } catch (error) {
  ...
  Future<void> deleteProduct(String id) async {
    ...
    // _items.removeWhere((product) => product.id == id); //alt
  }
}
